...
// an array of arrays
// => sum of all nums in each inner array
// ie: stairs = [monday, tuesday] ... monday = [2,2,2] ... tuesday = [3,3,3] => 15

function stairsIn20(s) {
   // for each array, find sum of each and return sum of all nums * 20
   return stairs.map(arr => arr.reduce((acc, c) => acc + c)).reduce((acc, c) => acc + c) * 20
}
